...
const translations = {
    'zh-CN': {
        ...
        copyright: '@2025 KozekiUi.wntab.work',
        rights: '保留所有权利；',
        friendlyLinks: '友情链接',
        RefHide: 'SAKFSU',
        ...
        copyFailed: '复制失败，请重试',
        contactEmail: '邮箱：',
        emailAddress: 'hi@KozekiUi.wntab.work',
        howToUse: '如何高效加水印？',
        ...
        themeLoadSuccess: '主题加载成功',
        themeLoadError: '主题加载失败，请重试'
    },
    'en': {
        title: 'Batch Image Watermark Tool',
        logo: 'Watermark Adder',
        heading: 'Batch Image Watermark Tool',
        subheading: 'Quickly add custom watermarks to images, very simple to use',
        ...
        filesSelected: 'images selected',
        pasteAreaText: 'Click to upload, paste or drag images here',
        resetButton: 'Reset',
        ...
        qaTitle: 'FAQ',
        qa1Title: 'Why choose KozekiUi.wntab.work?',
        ...
        qa2Title: 'How does KozekiUi.wntab.work protect user privacy?',
        ...
        someImagesIgnored: 'Added {0} images, {1} ignored due to limit',
                themeLoadSuccess: 'Theme loaded successfully',
        themeLoadError: 'Failed to load theme. Please try again.'
    }
};
